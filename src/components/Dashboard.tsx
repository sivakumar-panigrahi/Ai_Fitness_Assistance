...
import { calculateBMI, getBMICategory, getAgeGroup, badgeDefinitions } from '@/lib/fitnessEngine';
          ...
          <TabsContent value="yoga" className="space-y-4 animate-fade-in">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {recommendations.yogaVideos.map((video, i) => (
                <Card key={i} className="card-hover shadow-soft overflow-hidden group" style={{ animationDelay: `${i * 100}ms` }}>
                  <div className="relative aspect-video bg-muted overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-foreground/30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <a 
                        ...
                        className="w-16 h-16 rounded-full bg-primary-foreground flex items-center justify-center shadow-medium"
                      >
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant="secondary" className="capitalize">{video.difficulty}</Badge>
                      <a 
                        href={video.url} 
                        target="_blank" 
                        rel="noopener noreferrer"
